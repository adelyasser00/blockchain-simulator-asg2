...
public class SampleTxCase {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException,
		...
		// ( this should return true if Tx3 is false and vice versa, Only one should go through )
		...
		// TX7 tries to use same input utxo twice. same owner of Tx3 ( This should return false )
